[![Build Status](https://dev.azure.com/alivaseghnia/MyAzureProject/_apis/build/status/AliVaseghnia.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/alivaseghnia/MyAzureProject/_build/latest?definitionId=1&branchName=master)
